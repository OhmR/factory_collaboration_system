...
export default function Chart(props) {
  const { data } = props;
  console.info('in tree order', data);
      ...
      tooltip: {
        ...
        formatter: function(params) {
          ...
          for (let i = 0; i < params.data.children.length; i++) {
            console.info(i, params.data.children);
            if (params.data.children[i]) {
              output += params.data.children[i].name + "*" + params.data.children[i].num + "<br>"
            }
          }
